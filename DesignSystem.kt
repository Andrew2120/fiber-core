...
object BorderValuesContainer {
    ...
    val successSubtle = Color(parseColor("#5db5ab"))
...
object SuccessValuesContainer {
    ...
    val actionSuccessSubtleActive = Color(parseColor("#5db5ab"))
...
object GreenValuesContainer {
    ...
    val nonSemanticGreenBorderSubtle = Color(parseColor("#5db5ab"))
...
object SuccessValuesContainer1 {
    ...
    val semanticSuccess3 = Color(parseColor("#5db5ab"))
...
object GreenValuesContainer1 {
    ...
    val green3 = Color(parseColor("#5db5ab"))
