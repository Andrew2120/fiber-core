...
object BorderValuesContainer {
    ...
    val successSubtle = Color(parseColor("#fc1ce9"))
...
object SuccessValuesContainer {
    ...
    val actionSuccessSubtleActive = Color(parseColor("#fc1ce9"))
...
object GreenValuesContainer {
    ...
    val nonSemanticGreenBorderSubtle = Color(parseColor("#fc1ce9"))
...
object SuccessValuesContainer1 {
    ...
    val semanticSuccess3 = Color(parseColor("#fc1ce9"))
...
object GreenValuesContainer1 {
    ...
    val green3 = Color(parseColor("#fc1ce9"))
