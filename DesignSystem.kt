...
object BorderValuesContainer {
    ...
    val successSubtle = Color(parseColor("#e3a909"))
...
object SuccessValuesContainer {
    ...
    val actionSuccessSubtleActive = Color(parseColor("#e3a909"))
...
object GreenValuesContainer {
    ...
    val nonSemanticGreenBorderSubtle = Color(parseColor("#e3a909"))
...
object SuccessValuesContainer1 {
    ...
    val semanticSuccess3 = Color(parseColor("#e3a909"))
...
object GreenValuesContainer1 {
    ...
    val green3 = Color(parseColor("#e3a909"))
