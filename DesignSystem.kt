...
object BorderValuesContainer {
    ...
    val infoSubtle = Color(parseColor("#ff8000"))
...
object PrimaryValuesContainer {
    ...
    val actionPrimarySubtleActive = Color(parseColor("#ff8000"))
...
object DefaultValuesContainer {
    ...
    val interactionDefaultSubtleActive = Color(parseColor("#ff8000"))
...
object BlueValuesContainer {
    ...
    val nonSemanticBlueBorderSubtle = Color(parseColor("#ff8000"))
...
object BrandValuesContainer {
    val semanticBrandNegative4 = Color(parseColor("#fee7e7"))
    ...
    val semanticBrand3 = Color(parseColor("#ff8000"))
...
object InfoValuesContainer {
    ...
    val semanticInfo3 = Color(parseColor("#ff8000"))
...
object BlueValuesContainer1 {
    ...
    val blue3 = Color(parseColor("#ff8000"))
