...
object BorderValuesContainer {
    ...
    val successSubtle = Color(parseColor("#f9fc1b"))
...
object SuccessValuesContainer {
    ...
    val actionSuccessSubtleActive = Color(parseColor("#f9fc1b"))
...
object GreenValuesContainer {
    ...
    val nonSemanticGreenBorderSubtle = Color(parseColor("#f9fc1b"))
...
object SuccessValuesContainer1 {
    ...
    val semanticSuccess3 = Color(parseColor("#f9fc1b"))
...
object GreenValuesContainer1 {
    ...
    val green3 = Color(parseColor("#f9fc1b"))
