...
val _primary-inverse = Color("#ffffff".toColorInt())
val _secondary-inverse = Color("#ffffffa3".toColorInt())
val _tertiary-inverse = Color("#ffffff66".toColorInt())
val _disabled-inverse = Color("#ffffff3d".toColorInt())
val _info-primary = Color("#113997".toColorInt())
val _info-secondary = Color("#3061d5".toColorInt())
val _success-primary = Color("#135315".toColorInt())
val _success-secondary = Color("#347434".toColorInt())
val _warning-primary = Color("#000".toColorInt())
val _warning-secondary = Color("#f59638".toColorInt())
val _danger-primary = Color("#6f2020".toColorInt())
val _danger-secondary = Color("#c53434".toColorInt())
val _brand-primary = Color("#113997".toColorInt())
val _brand-secondary = Color("#3061d5".toColorInt())
}
...
val _neutral-strong = Color("#555f6d".toColorInt())
val _neutral-subtle = Color("#cfd6dd".toColorInt())
val _info-strong = Color("#3061d5".toColorInt())
val _info-subtle = Color("#ccdcff".toColorInt())
val _success-strong = Color("#347434".toColorInt())
val _success-subtle = Color("#c6ecc6".toColorInt())
val _warning-strong = Color("#f59638".toColorInt())
val _warning-subtle = Color("#ffd4a8".toColorInt())
val _danger-strong = Color("#c53434".toColorInt())
val _danger-subtle = Color("#fccfcf".toColorInt())
}
...
val _neutral-strong = Color("#555f6d".toColorInt())
val _neutral-muted = Color("#dee3e7".toColorInt())
val _neutral-onSubtle = Color("#eaedf0".toColorInt())
val _neutral-subtle = Color("#f5f7f9".toColorInt())
val _neutral-surface = Color("#fcfcfd".toColorInt())
val _info-strong = Color("#3061d5".toColorInt())
val _info-muted = Color("#d6e3ff".toColorInt())
val _info-onSubtle = Color("#e5eeff".toColorInt())
val _info-subtle = Color("#f5f8ff".toColorInt())
val _info-surface = Color("#fafbff".toColorInt())
val _success-strong = Color("#347434".toColorInt())
val _success-muted = Color("#cff2cf".toColorInt())
val _success-onSubtle = Color("#dff6df".toColorInt())
val _success-subtle = Color("#f4fbf4".toColorInt())
val _success-surface = Color("#fbfefb".toColorInt())
val _warning-strong = Color("#f59638".toColorInt())
val _warning-muted = Color("#fcdec0".toColorInt())
val _warning-onSubtle = Color("#ffe8d1".toColorInt())
val _warning-subtle = Color("#fff5eb".toColorInt())
val _warning-surface = Color("#fffcfa".toColorInt())
val _danger-strong = Color("#c53434".toColorInt())
val _danger-muted = Color("#fcd9d9".toColorInt())
val _danger-onSubtle = Color("#fee7e7".toColorInt())
val _danger-subtle = Color("#fef5f5".toColorInt())
val _danger-surface = Color("#fffafa".toColorInt())
val _brand-strong = Color("#3061d5".toColorInt())
val _brand-muted = Color("#d6e3ff".toColorInt())
val _brand-onSubtle = Color("#e5eeff".toColorInt())
val _brand-surface = Color("#fafbff".toColorInt())
val _brand-subtle = Color("#f5f8ff".toColorInt())
}
...
val cool_gray-0 = Color("#555f6d".toColorInt())
...
val cool_grayA-0 = Color("#182639bd".toColorInt())
...
val neutral_gray-0 = Color("#5e5e5e".toColorInt())
...
val neutral_grayA-0 = Color("#262627bd".toColorInt())
...
val warm_gray-0 = Color("#5f5f58".toColorInt())
...
val warm_grayA-0 = Color("#26261cbd".toColorInt())
...
val _min_3 = Color("#6f2020".toColorInt())
val _min_2 = Color("#952d2d".toColorInt())
val _min_1 = Color("#a13636".toColorInt())
val _0 = Color("#c53434".toColorInt())
val _Plus_1 = Color("#f26363".toColorInt())
val _Plus_2 = Color("#f49090".toColorInt())
val _Plus_3 = Color("#fccfcf".toColorInt())
val _Plus_4 = Color("#fcd9d9".toColorInt())
...
val _min_2 = Color("#892969".toColorInt())
val _min_1 = Color("#953274".toColorInt())
val _0 = Color("#b12f86".toColorInt())
val _Plus_1 = Color("#de5eb3".toColorInt())
...
val _Plus_1 = Color("#c466db".toColorInt())
...
val _min_2 = Color("#4e38bc".toColorInt())
val _min_1 = Color("#573fcf".toColorInt())
val _0 = Color("#634eca".toColorInt())
val _Plus_1 = Color("#927ef1".toColorInt())
val _Plus_2 = Color("#aba2fb".toColorInt())
val _Plus_3 = Color("#dcd6ff".toColorInt())
...
val _min_2 = Color("#1e4fc2".toColorInt())
val _min_1 = Color("#2759ce".toColorInt())
val _0 = Color("#3061d5".toColorInt())
val _Plus_1 = Color("#6691f4".toColorInt())
val _Plus_2 = Color("#8eb0fb".toColorInt())
val _Plus_3 = Color("#ccdcff".toColorInt())
...
val _min_3 = Color("#0c456e".toColorInt())
val _min_2 = Color("#165c8d".toColorInt())
val _min_1 = Color("#1b679d".toColorInt())
...
val _min_3 = Color("#0a495c".toColorInt())
val _min_2 = Color("#196076".toColorInt())
...
val _min_3 = Color("#135315".toColorInt())
...
val _min_3 = Color("#000".toColorInt())
