...
val _success_subtle = Color(parseColor("#f00"))
...
val action_min_subtle_active = Color(parseColor("#f00"))
...
val nonSemantic_min_border_subtle = Color(parseColor("#f00"))
...
val semantic__Plus_3 = Color(parseColor("#f00"))
...
val _Plus_3 = Color(parseColor("#f00"))
