...
var indentStatements = function (statements, numberOfIndentations) {
    var indentation = '    ';
    return statements.map(function (statement) { return indentation.repeat(numberOfIndentations) + statement; }).join('\n');
};
