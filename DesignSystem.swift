...
struct BorderValuesContainer {
    ...
    let successSubtle = SwiftUI.Color(hex: "f9fc1b")
...
struct SuccessValuesContainer {
    ...
    let actionSuccessSubtleActive = SwiftUI.Color(hex: "f9fc1b")
...
struct GreenValuesContainer {
    ...
    let nonSemanticGreenBorderSubtle = SwiftUI.Color(hex: "f9fc1b")
...
struct SuccessValuesContainer1 {
    ...
    let semanticSuccess3 = SwiftUI.Color(hex: "f9fc1b")
...
struct GreenValuesContainer1 {
    ...
    let green3 = SwiftUI.Color(hex: "f9fc1b")
