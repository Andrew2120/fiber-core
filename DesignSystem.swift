...
struct BorderValuesContainer {
    ...
    let infoSubtle = SwiftUI.Color(hex: "9f6")
...
struct PrimaryValuesContainer {
    ...
    let actionPrimarySubtleActive = SwiftUI.Color(hex: "9f6")
...
struct DefaultValuesContainer {
    ...
    let interactionDefaultSubtleActive = SwiftUI.Color(hex: "9f6")
...
struct BlueValuesContainer {
    ...
    let nonSemanticBlueBorderSubtle = SwiftUI.Color(hex: "9f6")
...
struct BrandValuesContainer {
    ...
    let semanticBrand3 = SwiftUI.Color(hex: "9f6")
...
struct InfoValuesContainer {
    ...
    let semanticInfo3 = SwiftUI.Color(hex: "9f6")
...
struct BlueValuesContainer1 {
    ...
    let blue3 = SwiftUI.Color(hex: "9f6")
