...
struct ContentValuesContainer {
    ...
    let successSecondary = SwiftUI.Color(hex: "347434")
...
struct BorderValuesContainer {
    ...
    let infoSubtle = SwiftUI.Color(hex: "234794")
    let successStrong = SwiftUI.Color(hex: "347434")
    let successSubtle = SwiftUI.Color(hex: "c72d2d")
...
struct PrimaryValuesContainer {
    ...
    let actionPrimarySubtleActive = SwiftUI.Color(hex: "234794")
...
struct SuccessValuesContainer {
    let actionSuccessNormal = SwiftUI.Color(hex: "347434")
    ...
    let actionSuccessSubtleActive = SwiftUI.Color(hex: "c72d2d")
...
struct DefaultValuesContainer {
    ...
    let interactionDefaultSubtleActive = SwiftUI.Color(hex: "234794")
...
struct BlueValuesContainer {
    ...
    let nonSemanticBlueBorderSubtle = SwiftUI.Color(hex: "234794")
...
struct GreenValuesContainer {
    ...
    let nonSemanticGreenContentSecondary = SwiftUI.Color(hex: "347434")
    let nonSemanticGreenBorderDefault = SwiftUI.Color(hex: "dff6df")
    let nonSemanticGreenBorderStrong = SwiftUI.Color(hex: "347434")
    let nonSemanticGreenBorderSubtle = SwiftUI.Color(hex: "c72d2d")
    let nonSemanticGreenBackgroundStrong = SwiftUI.Color(hex: "347434")
...
struct BrandValuesContainer {
    ...
    let semanticBrand3 = SwiftUI.Color(hex: "234794")
...
struct InfoValuesContainer {
    ...
    let semanticInfo3 = SwiftUI.Color(hex: "234794")
...
struct SuccessValuesContainer1 {
    ...
    let semanticSuccess0 = SwiftUI.Color(hex: "347434")
    let semanticSuccess1 = SwiftUI.Color(hex: "55a555")
    let semanticSuccess2 = SwiftUI.Color(hex: "9587c9")
    let semanticSuccess3 = SwiftUI.Color(hex: "c72d2d")
...
struct BlueValuesContainer1 {
    ...
    let blue3 = SwiftUI.Color(hex: "234794")
...
struct GreenValuesContainer1 {
    ...
    let green0 = SwiftUI.Color(hex: "347434")
    let green1 = SwiftUI.Color(hex: "55a555")
    let green2 = SwiftUI.Color(hex: "9587c9")
    let green3 = SwiftUI.Color(hex: "c72d2d")
