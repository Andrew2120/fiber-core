...
struct BorderValuesContainer {
    ...
    let successSubtle = SwiftUI.Color(hex: "e3a909")
...
struct SuccessValuesContainer {
    ...
    let actionSuccessSubtleActive = SwiftUI.Color(hex: "e3a909")
...
struct GreenValuesContainer {
    ...
    let nonSemanticGreenBorderSubtle = SwiftUI.Color(hex: "e3a909")
...
struct SuccessValuesContainer1 {
    ...
    let semanticSuccess3 = SwiftUI.Color(hex: "e3a909")
...
struct GreenValuesContainer1 {
    ...
    let green3 = SwiftUI.Color(hex: "e3a909")
