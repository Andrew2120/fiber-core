...
struct ContentValuesContainer {
    ...
    let successSecondary = SwiftUI.Color(hex: "47d20c")
...
struct BorderValuesContainer {
    ...
    let successStrong = SwiftUI.Color(hex: "47d20c")
...
struct SuccessValuesContainer {
    let actionSuccessNormal = SwiftUI.Color(hex: "47d20c")
...
struct GreenValuesContainer {
    ...
    let nonSemanticGreenContentSecondary = SwiftUI.Color(hex: "47d20c")
    let nonSemanticGreenBorderDefault = SwiftUI.Color(hex: "dff6df")
    let nonSemanticGreenBorderStrong = SwiftUI.Color(hex: "47d20c")
    let nonSemanticGreenBorderSubtle = SwiftUI.Color(hex: "0005ff")
    let nonSemanticGreenBackgroundStrong = SwiftUI.Color(hex: "47d20c")
...
struct SuccessValuesContainer1 {
    ...
    let semanticSuccess0 = SwiftUI.Color(hex: "47d20c")
...
struct GreenValuesContainer1 {
    ...
    let green0 = SwiftUI.Color(hex: "47d20c")
