...
struct BorderValuesContainer {
    ...
    let infoSubtle = SwiftUI.Color(hex: "00ffff")
...
struct PrimaryValuesContainer {
    ...
    let actionPrimarySubtleActive = SwiftUI.Color(hex: "00ffff")
...
struct DefaultValuesContainer {
    ...
    let interactionDefaultSubtleActive = SwiftUI.Color(hex: "00ffff")
...
struct BlueValuesContainer {
    ...
    let nonSemanticBlueBorderSubtle = SwiftUI.Color(hex: "00ffff")
...
struct BrandValuesContainer {
    let semanticBrandNegative4 = SwiftUI.Color(hex: "00ffff")
    ...
    let semanticBrand3 = SwiftUI.Color(hex: "00ffff")
...
struct InfoValuesContainer {
    ...
    let semanticInfo3 = SwiftUI.Color(hex: "00ffff")
...
struct BlueValuesContainer1 {
    ...
    let blue3 = SwiftUI.Color(hex: "00ffff")
