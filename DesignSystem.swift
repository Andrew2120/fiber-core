...
struct ContentValuesContainer {
    ...
    let successSecondary = SwiftUI.Color(hex: "b0431f")
...
struct BorderValuesContainer {
    ...
    let successStrong = SwiftUI.Color(hex: "b0431f")
...
struct SuccessValuesContainer {
    let actionSuccessNormal = SwiftUI.Color(hex: "b0431f")
...
struct GreenValuesContainer {
    ...
    let nonSemanticGreenContentSecondary = SwiftUI.Color(hex: "b0431f")
    let nonSemanticGreenBorderDefault = SwiftUI.Color(hex: "dff6df")
    let nonSemanticGreenBorderStrong = SwiftUI.Color(hex: "b0431f")
    let nonSemanticGreenBorderSubtle = SwiftUI.Color(hex: "0005ff")
    let nonSemanticGreenBackgroundStrong = SwiftUI.Color(hex: "b0431f")
...
struct SuccessValuesContainer1 {
    ...
    let semanticSuccess0 = SwiftUI.Color(hex: "b0431f")
...
struct GreenValuesContainer1 {
    ...
    let green0 = SwiftUI.Color(hex: "b0431f")
