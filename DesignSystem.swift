...
struct ContentValuesContainer {
    ...
    let successSecondary = SwiftUI.Color(hex: "2026b0")
...
struct BorderValuesContainer {
    ...
    let successStrong = SwiftUI.Color(hex: "2026b0")
...
struct SuccessValuesContainer {
    let actionSuccessNormal = SwiftUI.Color(hex: "2026b0")
...
struct GreenValuesContainer {
    ...
    let nonSemanticGreenContentSecondary = SwiftUI.Color(hex: "2026b0")
    let nonSemanticGreenBorderDefault = SwiftUI.Color(hex: "dff6df")
    let nonSemanticGreenBorderStrong = SwiftUI.Color(hex: "2026b0")
    let nonSemanticGreenBorderSubtle = SwiftUI.Color(hex: "0005ff")
    let nonSemanticGreenBackgroundStrong = SwiftUI.Color(hex: "2026b0")
...
struct SuccessValuesContainer1 {
    ...
    let semanticSuccess0 = SwiftUI.Color(hex: "2026b0")
...
struct GreenValuesContainer1 {
    ...
    let green0 = SwiftUI.Color(hex: "2026b0")
