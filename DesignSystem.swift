...
struct BorderValuesContainer {
    ...
    let infoSubtle = SwiftUI.Color(hex: "06848f")
    let successStrong = SwiftUI.Color(hex: "347434")
    let successSubtle = SwiftUI.Color(hex: "cb0717")
...
struct PrimaryValuesContainer {
    ...
    let actionPrimarySubtleActive = SwiftUI.Color(hex: "06848f")
...
struct SuccessValuesContainer {
    ...
    let actionSuccessSubtleActive = SwiftUI.Color(hex: "cb0717")
...
struct DefaultValuesContainer {
    ...
    let interactionDefaultSubtleActive = SwiftUI.Color(hex: "06848f")
...
struct BlueValuesContainer {
    ...
    let nonSemanticBlueBorderSubtle = SwiftUI.Color(hex: "06848f")
...
struct GreenValuesContainer {
    ...
    let nonSemanticGreenBorderSubtle = SwiftUI.Color(hex: "cb0717")
...
struct BrandValuesContainer {
    ...
    let semanticBrand3 = SwiftUI.Color(hex: "06848f")
...
struct InfoValuesContainer {
    ...
    let semanticInfo3 = SwiftUI.Color(hex: "06848f")
...
struct SuccessValuesContainer1 {
    ...
    let semanticSuccess3 = SwiftUI.Color(hex: "cb0717")
...
struct BlueValuesContainer1 {
    ...
    let blue3 = SwiftUI.Color(hex: "06848f")
...
struct GreenValuesContainer1 {
    ...
    let green3 = SwiftUI.Color(hex: "cb0717")
