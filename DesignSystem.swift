...
struct BorderValuesContainer {
    ...
    let successSubtle = SwiftUI.Color(hex: "5db5ab")
...
struct SuccessValuesContainer {
    ...
    let actionSuccessSubtleActive = SwiftUI.Color(hex: "5db5ab")
...
struct GreenValuesContainer {
    ...
    let nonSemanticGreenBorderSubtle = SwiftUI.Color(hex: "5db5ab")
...
struct SuccessValuesContainer1 {
    ...
    let semanticSuccess3 = SwiftUI.Color(hex: "5db5ab")
...
struct GreenValuesContainer1 {
    ...
    let green3 = SwiftUI.Color(hex: "5db5ab")
