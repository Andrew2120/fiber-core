...
struct BorderValuesContainer {
    ...
    let infoSubtle = SwiftUI.Color(hex: "c91dc2")
    let successStrong = SwiftUI.Color(hex: "347434")
    let successSubtle = SwiftUI.Color(hex: "299104")
...
struct PrimaryValuesContainer {
    ...
    let actionPrimarySubtleActive = SwiftUI.Color(hex: "c91dc2")
...
struct SuccessValuesContainer {
    ...
    let actionSuccessSubtleActive = SwiftUI.Color(hex: "299104")
...
struct DefaultValuesContainer {
    ...
    let interactionDefaultSubtleActive = SwiftUI.Color(hex: "c91dc2")
...
struct BlueValuesContainer {
    ...
    let nonSemanticBlueBorderSubtle = SwiftUI.Color(hex: "c91dc2")
...
struct GreenValuesContainer {
    ...
    let nonSemanticGreenBorderSubtle = SwiftUI.Color(hex: "299104")
...
struct BrandValuesContainer {
    ...
    let semanticBrand3 = SwiftUI.Color(hex: "c91dc2")
...
struct InfoValuesContainer {
    ...
    let semanticInfo3 = SwiftUI.Color(hex: "c91dc2")
...
struct SuccessValuesContainer1 {
    ...
    let semanticSuccess3 = SwiftUI.Color(hex: "299104")
...
struct BlueValuesContainer1 {
    ...
    let blue3 = SwiftUI.Color(hex: "c91dc2")
...
struct GreenValuesContainer1 {
    ...
    let green3 = SwiftUI.Color(hex: "299104")
