...
struct BorderValuesContainer {
    ...
    let successSubtle = SwiftUI.Color(hex: "940b37")
...
struct SuccessValuesContainer {
    ...
    let actionSuccessSubtleActive = SwiftUI.Color(hex: "940b37")
...
struct GreenValuesContainer {
    ...
    let nonSemanticGreenBorderSubtle = SwiftUI.Color(hex: "940b37")
...
struct SuccessValuesContainer1 {
    ...
    let semanticSuccess3 = SwiftUI.Color(hex: "940b37")
...
struct GreenValuesContainer1 {
    ...
    let green3 = SwiftUI.Color(hex: "940b37")
