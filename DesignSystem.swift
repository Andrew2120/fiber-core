...
struct ContentValuesContainer {
    ...
    let successSecondary = SwiftUI.Color(hex: "850dd1")
...
struct BorderValuesContainer {
    ...
    let successStrong = SwiftUI.Color(hex: "850dd1")
...
struct SuccessValuesContainer {
    let actionSuccessNormal = SwiftUI.Color(hex: "850dd1")
...
struct GreenValuesContainer {
    ...
    let nonSemanticGreenContentSecondary = SwiftUI.Color(hex: "850dd1")
    let nonSemanticGreenBorderDefault = SwiftUI.Color(hex: "dff6df")
    let nonSemanticGreenBorderStrong = SwiftUI.Color(hex: "850dd1")
    let nonSemanticGreenBorderSubtle = SwiftUI.Color(hex: "0005ff")
    let nonSemanticGreenBackgroundStrong = SwiftUI.Color(hex: "850dd1")
...
struct SuccessValuesContainer1 {
    ...
    let semanticSuccess0 = SwiftUI.Color(hex: "850dd1")
...
struct GreenValuesContainer1 {
    ...
    let green0 = SwiftUI.Color(hex: "850dd1")
