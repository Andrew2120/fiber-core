...
struct ContentValuesContainer {
    ...
    let successSecondary = SwiftUI.Color(hex: "b0203d")
...
struct BorderValuesContainer {
    ...
    let successStrong = SwiftUI.Color(hex: "b0203d")
...
struct SuccessValuesContainer {
    let actionSuccessNormal = SwiftUI.Color(hex: "b0203d")
...
struct GreenValuesContainer {
    ...
    let nonSemanticGreenContentSecondary = SwiftUI.Color(hex: "b0203d")
    let nonSemanticGreenBorderDefault = SwiftUI.Color(hex: "dff6df")
    let nonSemanticGreenBorderStrong = SwiftUI.Color(hex: "b0203d")
    let nonSemanticGreenBorderSubtle = SwiftUI.Color(hex: "0005ff")
    let nonSemanticGreenBackgroundStrong = SwiftUI.Color(hex: "b0203d")
...
struct SuccessValuesContainer1 {
    ...
    let semanticSuccess0 = SwiftUI.Color(hex: "b0203d")
...
struct GreenValuesContainer1 {
    ...
    let green0 = SwiftUI.Color(hex: "b0203d")
