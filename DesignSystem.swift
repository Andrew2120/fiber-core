...
struct ContentValuesContainer {
    ...
    let successSecondary = SwiftUI.Color(hex: "31d10d")
...
struct BorderValuesContainer {
    ...
    let successStrong = SwiftUI.Color(hex: "31d10d")
...
struct SuccessValuesContainer {
    let actionSuccessNormal = SwiftUI.Color(hex: "31d10d")
...
struct GreenValuesContainer {
    ...
    let nonSemanticGreenContentSecondary = SwiftUI.Color(hex: "31d10d")
    let nonSemanticGreenBorderDefault = SwiftUI.Color(hex: "dff6df")
    let nonSemanticGreenBorderStrong = SwiftUI.Color(hex: "31d10d")
    let nonSemanticGreenBorderSubtle = SwiftUI.Color(hex: "0005ff")
    let nonSemanticGreenBackgroundStrong = SwiftUI.Color(hex: "31d10d")
...
struct SuccessValuesContainer1 {
    ...
    let semanticSuccess0 = SwiftUI.Color(hex: "31d10d")
...
struct GreenValuesContainer1 {
    ...
    let green0 = SwiftUI.Color(hex: "31d10d")
