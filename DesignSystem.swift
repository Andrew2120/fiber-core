...
struct BorderValuesContainer {
    ...
    let successSubtle = SwiftUI.Color(hex: "fc1ce9")
...
struct SuccessValuesContainer {
    ...
    let actionSuccessSubtleActive = SwiftUI.Color(hex: "fc1ce9")
...
struct GreenValuesContainer {
    ...
    let nonSemanticGreenBorderSubtle = SwiftUI.Color(hex: "fc1ce9")
...
struct SuccessValuesContainer1 {
    ...
    let semanticSuccess3 = SwiftUI.Color(hex: "fc1ce9")
...
struct GreenValuesContainer1 {
    ...
    let green3 = SwiftUI.Color(hex: "fc1ce9")
