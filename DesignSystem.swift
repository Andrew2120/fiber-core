...
struct BorderValuesContainer {
    ...
    let infoSubtle = SwiftUI.Color(hex: "ff8000")
...
struct PrimaryValuesContainer {
    ...
    let actionPrimarySubtleActive = SwiftUI.Color(hex: "ff8000")
...
struct DefaultValuesContainer {
    ...
    let interactionDefaultSubtleActive = SwiftUI.Color(hex: "ff8000")
...
struct BlueValuesContainer {
    ...
    let nonSemanticBlueBorderSubtle = SwiftUI.Color(hex: "ff8000")
...
struct BrandValuesContainer {
    let semanticBrandNegative4 = SwiftUI.Color(hex: "d15a5a")
    ...
    let semanticBrand3 = SwiftUI.Color(hex: "ff8000")
...
struct InfoValuesContainer {
    ...
    let semanticInfo3 = SwiftUI.Color(hex: "ff8000")
...
struct BlueValuesContainer1 {
    ...
    let blue3 = SwiftUI.Color(hex: "ff8000")
